...
public class ESIQuiz extends Application {
    ...
    public static void main(String[] args) {
        ...
        Date dateDeNaissance = DateUtils.getDate(1999, Calendar.NOVEMBER, 13);
        Date dateDeFin = DateUtils.getDate(2020, Calendar.NOVEMBER, 13);
        ...
        gestForm1.retirerApprenant(formation_1.getId(), apprenant_3.getId());
       ...
       List<Apprenant> apprenants_trié=  gestApprenant.trierApprenantsSelonMoyenne(true);
        /// afficher la list trié
       gestForm1.afficherApprenants(formation_1.getId());
